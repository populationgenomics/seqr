...
class MatchmakerAPITest(AuthenticationTestCase):
    ...
    def test_get_individual_mme_matches(self, mock_analyst_group):
        ...
        self.assertDictEqual(response_json['mmeSubmissionsByGuid'], {SUBMISSION_GUID: {
            ...
            'contactHref': 'mailto:seqr-matchmaker@populationgenomics.org.au,test_user@broadinstitute.org',
    ...
    def test_search_individual_mme_matches(self, mock_nodes, mock_email, mock_slacker, mock_logger):
        ...
        expected_patient_body = {
            'patient': {
                ...
                'label': 'NA19675_1',
                'contact': {
                    'href': 'mailto:seqr-matchmaker@populationgenomics.org.au,test_user@broadinstitute.org',
                    'name': 'Sam Baxter',
    ...
    """
        ...
        mock_email.assert_called_with(
            ...
            from_email='seqr-matchmaker@populationgenomics.org.au')
    ...
    def test_update_mme_submission(self, mock_mme_nodes):
        ...
        update_body = {
            'individualGuid': NO_SUBMISSION_INDIVIDUAL_GUID,
            'contactHref': 'mailto:seqr-matchmaker@populationgenomics.org.au',
        ...
        self.assertDictEqual(response_json['mmeResultsByGuid'][new_internal_match_guid], {
            ...
            'patient': {
                ...
                'contact': {
                    'href': 'mailto:seqr-matchmaker@populationgenomics.org.au',
                    'name': 'Sam Baxter',
                    'institution': 'Broad Center for Mendelian Genomics'
                },
                'id': 'NA20885',
        ...
        expected_body = {
            'patient': {
                'id': NO_SUBMISSION_INDIVIDUAL_GUID,
                'label': 'HG00733',
                'contact': {'href': 'mailto:seqr-matchmaker@populationgenomics.org.au', 'name': 'Test Name',
                            'institution': 'Broad Center for Mendelian Genomics'},
                'species': 'NCBITaxon:9606',
                'sex': 'FEMALE',
                'features': [
