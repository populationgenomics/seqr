...
import {
  getVisibleFamilies, getVisibleFamiliesInSortedOrder, getFamiliesExportData, getIndividualsExportData,
...
test('getDefaultMmeSubmission', () => {
  ...
  expect(defaultSubmissions).toEqual({
    contactName: 'PI',
    contactHref: 'test@populationgenomics.org.au',
    geneVariants: [],
    phenotypes: [],
  })
})
...
test('getMmeDefaultContactEmail', () => {
  expect(getMmeDefaultContactEmail(STATE_WITH_2_FAMILIES, { matchmakerResultGuid: 'MR0005038_HK018_0047' })).toEqual({
    ...
    patientId: '12531',
    to: 'crowley@unc.edu,test@test.com,test@populationgenomics.org.au',
