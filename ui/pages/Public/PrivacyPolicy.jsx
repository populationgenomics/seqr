    ...
    <List ordered>
      ...
      <List.Item>
        ...
        <List as="ul">
          ...
          <List.Item as="li">
            "Device Information" is information that relates to a particular computer,
          ...
          <List.Item as="li">
            "Location Information" is information that can be used to identify your
            ...
            infer the location of a device that you may be using.
          </List.Item>
        </List>
      </List.Item>
      <List.Item>
        ...
        <List as="ul">
          <List.Item as="li">
            Session Cookies. Session cookies exist only during a session. They disappear
            ...
            as you move through our Platform, and to optimize your experience when using the Platform.
          </List.Item>
          <List.Item as="li">
      ...
      <List.Item>
        <b>How do we use your information?</b>
          ...
          <List as="ul">
          <List.Item as="li">
            Provide the Platform. We, and our vendors and service providers, use your information
          ...
          <List.Item as="li">
            Personalize Your Experience. We use your information to tailor the content and
          ...
          <List.Item as="li">
            Improve and Develop Our Platform. We use your information to ensure our Platform
            ...
            features and applications, and for other research and analytical purposes.
            </List.Item>
        </List>
      </List.Item>
      <List.Item>
        <b>With whom do we share your information?</b>
          ...
          <List as="ul">
          <List.Item as="li">
            Other Users. The purpose of the Platform is to facilitate the sharing of information
            and collaboration. During such collaboration, Personal Information you supplied during the
            registration process may be visible to other Platform users.
            </List.Item>
          <List.Item as="li">
            Vendors and Service Providers. We use various third-party vendors and service providers
          ...
          <List.Item as="li">
            Marketing. We do not rent, sell, or share Personal Information about you with other
            people or unaffiliated organizations for marketing purposes.
            </List.Item>
          <List.Item as="li">
            As Required By Law. We may be required, by law, to disclose your Personal Information
            to third parties, such as in the following situations:
              <List as="ul">
              <List.Item as="li">In response to a request by law enforcement;</List.Item>
              <List.Item as="li">
                In response to legal process, such as a subpoena, a request for discovery in a
                civil proceeding, or in response to a court order.
                </List.Item>
              <List.Item as="li">
                Enforce Our Terms and Protect You, Us and Others. We may access, preserve,
                and disclose your Personal Information to enforce the Terms of Use for the Platform
                and protect your, our, or others’ rights, property, or safety.
                </List.Item>
              <List.Item as="li">
                Enforce Our Terms and Protect You, Us and Others. We may access, preserve,
                and disclose your Personal Information to enforce the Terms of Use for the Platform
              ...
              <List.Item as="li">
                Merger, Sale, or Other Corporate Transactions. A legal entity, such as Garvan,
                ...
                or transferred as part of such a transaction as permitted by law and/or contract.
                </List.Item>
              <List.Item as="li">
                With Your Consent. We may ask you from time to time to give us permission to share
                your information with other third parties not described in this section. In each case,
                we will describe that third party and the purpose for sharing your information.
                </List.Item>
              <List.Item as="li">
                ...
                advertising, research, or similar purposes. This information will not identify you personally.
                </List.Item>
            </List>
          </List.Item>
        </List>
      ...
      <List.Item>
        <b>Notice to Residents of the European Union.</b>
          ...
          <List as="ul">
          <List.Item as="li">
            Performance of a contract. We will process your Personal Information to provide the
          ...
          <List.Item as="li">
            ...
            harm to your rights and freedoms, including:
              <List as="ul">
              <List.Item as="li">
                improving our products and services and the content on Platform
                (for example to manage our network, improve the Platform, and better tailor the features,
                performance and support of the Platform);
                </List.Item>
              ...
              <List.Item as="li">
                EU Data Subject Rights. Data Subjects of the European Union have the following rights:
                  <List as="ul">
                  <List.Item as="li">
                    Access, Correction and Erasure Requests: You have the right to:
                      ...
                      <List.Item as="li">
                        ...
                        <List as="ul">
                          ...
                          <List.Item as="li">
                            where you have submitted an objection to processing based upon our legitimate business
