...
export default () =>
  <Segment basic padded="very">
    <Header dividing content="CPG seqr Privacy Policy" subheader="Last Updated 113-MAY-2021" size="huge" />
    ...
    questions about this Policy, please contact us at <a href="mailto:seqr@populationgenomics.org.au"> 
    seqr@populationgenomics.org.au </a> <br />
    ...
    <b> 2. What is the purpose and scope of this Policy?</b>
    ...
    <b> 3. Does this Policy Apply to Genomic Data Uploaded to the Platform?</b>
    ...
    the relevant Genomic Data contributor is responsible for obtaining all necessary 
    permissions and consents for such data. If you are a user of the Platform, you are 
    required to keep the Genomic Data confidential and not to disclose such data to any 
    third party, except other users of the Platform with permission to view it. 
    ...
    <b> 4. If I use the Platform, am I agreeing to this Policy?</b>
    ...
    <b> 5. How do we collect information from you?</b>
    ...
    which is required:
    <List bulleted>
      <List.Item>register to use the Platform, such as when you create an account 
      on the Platform, in which case we collect your name and email address;</List.Item>
      <List.Item>use the Platform, such as comments, material or information you may 
      post on or upload to the Platform ("User Content"); and;</List.Item>
      <List.Item>communicate with us (e.g., by email).</List.Item> <br />
     ...
     noted below. The second way we collect information is through certain automated 
     technologies that are used when you access our Platform. An example is a "cookie", 
     which is a small piece of computer code that is placed on your computer or other device 
     that can be used for various purposes, such as to recognize a user or to track their 
     activities on a website. We describe automated technologies in more detail in Section 7 
     below. We collect various information through these automated technologies, including 
    ...
    <b> 6. What kind of information do we collect?</b>
    We collect various types of information:
    <List bulleted>
      <List.Item>"Personal Information" is information that alone or in combination 
      with other information may be used to readily identify, contact, or locate you. 
      For example, your name and email address are Personal Information we may collect 
      through your use of the Platform;</List.Item>
      <List.Item>"Device Information" is information that relates to a particular computer, 
      mobile device, or other device (e.g., iPad) that you use to access the Platform. 
      Device information includes such things as an IP address (which is a number assigned 
      by an internet service provider to the computer you use to access the Internet), 
      a device ID (which is a number assigned to a mobile phone by the device manufacturer), 
      or the type of operating system or web browser used to access the Platform.</List.Item>
      <List.Item>"Location Information" is information that can be used to identify your 
      geographical location, such as where you are geographically located when you are 
      accessing the Platform using a mobile phone. We will not collect Location Information 
      from your mobile phone using a location-based service without sending you a separate 
      notice to your mobile phone and obtaining your consent. Please note, however, that 
      certain automated technologies such as cookies can identify IP addresses and other data to 
      infer the location of a device that you may be using.</List.Item>  <br />
    
    <b> 7. Do we use cookies and other tracking technologies?</b>
    ...
    <List bulleted>
      <List.Item>Session Cookies. Session cookies exist only during a session. They disappear 
      from your computer or device when you close your browser or App or turn off your 
      computer or device. We use Session Cookies to allow our systems to uniquely identify you 
      during a session or while you are logged into the Platform. This allows us to process 
      your communications and requests and verify your identity after you have logged in and 
      as you move through our Platform, and to optimize your experience when using the Platform.</List.Item>
      <List.Item>Persistent Cookies. Persistent Cookies remain on your computer or device after 
      you have closed your browser or turned off your computer or mobile device. We use persistent 
      cookies such as local storage objects, and other similar technologies to track activity on 
      our Platform and to enhance the functionality of our Platform to track aggregate and 
      statistical information about user activity on our Platform (see "Tracking Technologies" below). 
      We may also use local storage objects to collect and store information about your visits 
      to our Platform, such as page visits, the duration of the visit, the specific link(s) 
      that you clicked during your visit, and the address of the website from which you arrived 
      at the Platform.</List.Item> <br />
        
     <b> Disabling cookies.</b> Most web browsers automatically accept cookies, but if you prefer, you 
     ...
     <b> Tracking Technologies.</b> We use automated devices and applications, such as Google Analytics, 
    ...
    <b> 8. How do we use your information?</b>
    We use your information, including your Personal Information, for various purposes:
    <List bulleted>
      <List.Item>Provide the Platform. We, and our vendors and service providers, use your information 
      (e.g. your Profile information, user identification, and password) to provide the Platform, 
      respond to your inquiries, and troubleshoot issues with the Platform, and for other customer 
      service purposes.</List.Item>
      <List.Item>Personalize Your Experience. We use your information to tailor the content and 
      information that we may send or display to you, to offer location customization, and 
      personalized help and instructions, and to otherwise personalize your experiences while 
      you are using the Platform.</List.Item>
      <List.Item>Improve and Develop Our Platform. We use your information to ensure our Platform 
      is working as intended, to better understand how users access and use our Platform, both on 
      an aggregated and individualized basis, to make improvements to our Platform, to develop new 
      features and applications, and for other research and analytical purposes.</List.Item> <br />

    <b> 9. With whom do we share your information?</b>
    ...
    <List bulleted>
     <List.Item>Other Users. The purpose of the Platform is to facilitate the sharing of information 
     and collaboration. During such collaboration, Personal Information you supplied during the 
     registration process may be visible to other Platform users.</List.Item>
     <List.Item>Vendors and Service Providers. We use various third-party vendors and service providers 
     that assist us in providing the Platform. For example, we may use third-party vendors to store 
     and authenticate account credentials, send email communications, and for hosting and storing 
     information collected through our Platform. We may need to share your information with these 
     vendors and service providers to enable them to provide these services to us. These service 
     providers and vendors are required to only use your information to provide their services to us 
     and in a manner consistent with this Policy.</List.Item>
     <List.Item>Marketing. We do not rent, sell, or share Personal Information about you with other 
     people or unaffiliated organizations for marketing purposes.</List.Item>
     <List.Item>As Required By Law. We may be required, by law, to disclose your Personal Information 
     to third parties, such as in the following situations:</List.Item>
        <List bulleted>
        <List.Item>In response to a request by law enforcement;</List.Item>
        <List.Item>In response to legal process, such as a subpoena, a request for discovery in a 
        civil proceeding, or in response to a court order.</List.Item>
     <List.Item>Enforce Our Terms and Protect You, Us and Others. We may access, preserve, 
     and disclose your Personal Information to enforce the Terms of Use for the Platform 
     and protect your, our, or others’ rights, property, or safety.</List.Item>
     <List.Item>Enforce Our Terms and Protect You, Us and Others. We may access, preserve, 
     and disclose your Personal Information to enforce the Terms of Use for the Platform 
     and protect your, our, or others’ rights, property, or safety.</List.Item>
     <List.Item>Merger, Sale, or Other Corporate Transactions. A legal entity, such as Garvan, 
     may be involved in a business transaction where its ownership or assets are sold or 
     transferred to another legal entity. This can happen in a merger with another legal entity, 
     an acquisition by another legal entity, a corporate reorganization, or a legal proceeding 
     (e.g. bankruptcy or receivership), where a trustee or other party takes over control of the entity. 
     In each of these situations, your information, including your Personal Information, may be sold 
     or transferred as part of such a transaction as permitted by law and/or contract.</List.Item>
     <List.Item>With Your Consent. We may ask you from time to time to give us permission to share 
     your information with other third parties not described in this section. In each case,
     we will describe that third party and the purpose for sharing your information.</List.Item>
     <List.Item>Aggregate and De-Identified Information. We may share aggregate or de-identified 
     information about users and their use of the Platform with third parties and publicly for marketing, 
     advertising, research, or similar purposes. This information will not identify you personally.</List.Item> <br />

     <b> 10. Can other users see my Personal Information?</b>
     ...
     <b> 11. What rights do I have with respect to my information?</b>
     ...
     We will respond to any user request as soon as we reasonably can, and within the time and in the 
     ...
     <b> 12. What kind of security does seqr use to protect my information?</b>
     ...
     <b> 13. Do you collect information from children?</b>
     ...
     <b> 14. Is there any transfer of Personal Information from one country to another?</b>
     ...
     <b> 15. Will your personal information be sent overseas?</b>
     ...
     <b> 16. What should you do if you have a complaint about the handling of your personal information?</b>
     ...
     <b> 17. Will you update or change this Policy?</b>
     ...
     <b> 18. HIPAA, Protected Health Information and Clinical Compliance Features.</b>
     ...
     <b> 19. Notice to Residents of the European Union.</b>
     ...
     <List bulleted>
        <List.Item>Performance of a contract. We will process your Personal Information to provide the 
        Platform to you, under the terms of the Terms of Service you've agreed to as a condition of 
        using the Platform.</List.Item>
        <List.Item>Legitimate interests. We may use your Personal Information for our legitimate 
        interests provided that our legitimate interests are not outweighed by any prejudice or 
        harm to your rights and freedoms, including:</List.Item>
        <List bulleted>
            <List.Item>improving our products and services and the content on Platform 
            (for example to manage our network, improve the Platform, and better tailor the features, 
            performance and support of the Platform);</List.Item>
        ...
        <List.Item>Consent. In some cases, you will give us consent to use your Personal Information 
        ...
        however, such withdrawal shall not affect the legality of any processing done before receipt of the withdrawal.</List.Item>
        <List.Item>Legal obligations. We may be required to process your Personal Information to comply with our legal obligations.</List.Item>
        <List.Item>Data Retention. We retain Personal Information about you for the time necessary to 
        accomplish the purpose for which such information was collected, usually for the duration of 
        any contractual relationship and for any period thereafter as legally required or permitted 
        by applicable law. Our retention policies reflect applicable statute of limitation periods 
        and legal requirements.</List.Item>
        <List.Item>EU Data Subject Rights. Data Subjects of the European Union have the following rights:</List.Item>
        <List bulleted>
            <List.Item>Access, Correction and Erasure Requests: You have the right to:</List.Item>
            <List bulleted>
                ...
                <List.Item>request that we delete Personal Information in certain circumstances.d</List.Item>
            <List.Item>Right to Object to Processing: You have the right to request that we cease 
            ...
            exercise or defence of a legal claim.</List.Item>
            <List.Item>Right to Restrict Processing: You have the right to request that we limit 
            ...
            process your Personal Information for the establishment, exercise or defence of a legal claim.</List.Item>
            <List.Item>Right to Restrict Processing: You have the right to request that we limit the processing of 
            your Personal Information:</List.Item>
            <List bulleted>
                <List.Item>while we are evaluating or in the process of responding to a request by you to update 
                or correct your Personal Information where such processing is unlawful and you do not want us to 
                delete your data;</List.Item>
                <List.Item>where we no longer require such data, but you want us to retain the data for the 
                establishment, exercise or defence of a legal claim; and</List.Item>
                <List.Item>where you have submitted an objection to processing based upon our legitimate business 
                interests, pending our response to such request.</List.Item>
            <List.Item>Data Portability Requests: You have the right to request that we provide you or a third 
            ...
            performance of a contract.</List.Item> <br />
     
     If you believe our processing of your Personal Information violates data protection laws, you have a legal 
     ...
     <b>Submitting Requests:</b> EU data subject can submit requests by contacting us at <a href="mailto:seqr@populationgenomics.org.au"> seqr@populationgenomics.org.au. 
